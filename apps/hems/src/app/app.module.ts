...
import { CreateCheckinDialogComponent } from './pages/checkin/dialogs/checkin/createCheckinDialog/create-checkin-dialog.component';
import { UpdateCheckinDialogComponent } from './pages/checkin/dialogs/checkin/updateCheckinDialog/update-checkin-dialog.component';
import { CreateCheckoutDialogComponent } from './pages/checkin/dialogs/checkout/createCheckoutDialog/create-checkout-dialog.component';
import { UpdateCheckoutDialogComponent } from './pages/checkin/dialogs/checkout/updateCheckoutDialog/update-checkout-dialog.component';
